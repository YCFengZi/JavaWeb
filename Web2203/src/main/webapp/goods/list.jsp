...
<div class="container">
    ...
    <div class="main">
        ...
        <div class="right-box">
            ...
            <div class="banner">
                <h2 align="center" style="padding-top: 15px"> 商品列表 <a href="/web2203/Login/login.jsp"/>查询</a>  <a href="/web2203/add/add.jsp"/>添加</a></h2>
                <table style="padding-top: 15px; margin: 0 auto">
                    ...
                    <c:forEach items="${li}" var="good" step="1" varStatus="status">
                        <tr>
                            <td width="50px">${status.count}</td>
                            <td width="50px">${good.name}</td>
                            <td width="50px">${good.price}</td>
                            <td width="50px">
                                <a href="/web2203/DetailsServlet?id=${good.id}">详情</a>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
                <img src="/web2203/goods/image/音理.png" alt="">
            </div>
